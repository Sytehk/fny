...
class UserSupportReply extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ...
            ->line("You Requested Support right? Our Support team already Replied your Question..")
            ->line("Please login your account and check your Support Request via the following url")
