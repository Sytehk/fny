...
class UserNewemailController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('user.mails.newemail',compact('supports','rewards'));
    ...
    public function show($ticket)
    {
        ...
        return view('user.support.show',compact('support','discussions','user','rewards'));
    }
    ...
    public function close($id)
    {
        ...
        return redirect()->route('userSupports','rewards');
